...
int linea_actual = 0;
    fseek(pf, 280, SEEK_SET);
 pos = ftell(pf);
    printf("La posición actual del puntero es %ld bytes.\n", pos);
while ( linea_actual <= 23) {
	fscanf(pf,"%s %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f",
        datos[linea_actual - 5].tipo_energia, &datos[linea_actual - 5].cant_generada[0],
        &datos[linea_actual - 5].cant_generada[1], &datos[linea_actual - 5].cant_generada[2],
        &datos[linea_actual - 5].cant_generada[3], &datos[linea_actual - 5].cant_generada[4],
        &datos[linea_actual - 5].cant_generada[5], &datos[linea_actual - 5].cant_generada[6],
        &datos[linea_actual - 5].cant_generada[7], &datos[linea_actual - 5].cant_generada[8],
        &datos[linea_actual - 5].cant_generada[9], &datos[linea_actual - 5].cant_generada[10],
        &datos[linea_actual - 5].cant_generada[11], &datos[linea_actual - 5].cant_generada[12],
        &datos[linea_actual - 5].cant_generada[13], &datos[linea_actual - 5].cant_generada[14],
        &datos[linea_actual - 5].cant_generada[15], &datos[linea_actual - 5].cant_generada[16],
        &datos[linea_actual - 5].cant_generada[17], &datos[linea_actual - 5].cant_generada[18],
        &datos[linea_actual - 5].cant_generada[19], &datos[linea_actual - 5].cant_generada[20],
        &datos[linea_actual - 5].cant_generada[21], &datos[linea_actual - 5].cant_generada[22],
        &datos[linea_actual - 5].cant_generada[23]);
